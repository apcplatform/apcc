...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees, int nHeight)
{
    ...
    int halvings = nHeight / 250000000;
    if (halvings >= 64)
        return nFees;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in AppleCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // AppleCoin: check proof-of-stake block signature
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "AppleCoin Genesis Block Time Stamp new 0717";
        CTransaction txNew;
        txNew.nTime = 1500283100;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500283100;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1877168;

                //// debug print
                assert(block.hashMerkleRoot == uint256("0xa0cead165920f1b033d3de181961afc5a1e9ec173e8af068102aa5f6a0e29cbe"));
...
unsigned char pchMessageStart[4] = { 0xe1, 0xa4, 0x5a, 0xed };  
